<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Loan_OrderResult_Bill.aspx.cs" Inherits="Order_Loan_OrderResult_Bill" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (ResultCode == '4120') {
                ...
                $('#Show_resultMsg').val('주문 등록이 실패했습니다. 관리자에게 문의하세요.');
            }
            ...
            if (chkPayWay == '2' || chkPayWay == '4' || chkPayWay == '6' || chkPayWay == '7' || chkPayWay == '8') {
...
<body>
    <div class="payfin_area">
        <div class="orderR-title-div">
            <img src="../Images/Order/orderPop-title.jpg" alt="주문완료" />
            ...
            <table class="orderRqs-table">
                <tr>
                    <th class="auto-style1">결과내용</th>
                    <td class="auto-style1">
                        <input type="text" name="Show_resultMsg" id="Show_resultMsg" style="width: 300px" value="" />
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <input type="hidden" name="loan_payMethod" style="width: 300px" readonly value="<%=loan_payMethod%>" />
                        <input type="text" name="Payway" style="width: 300px" readonly value="<%=Payway%>" />
                ...
                <tr>
                    <th><span>상품명</span></th>
                    <td>
                        <input type="text" name="loan_goodsName" style="width: 300px" readonly value="<%=loan_goodsName%>" />
                    </td>
                </tr>
                <tr>
                    <th><span>금액</span></th>
                    <td>
                        <input type="text" name="loan_Amt" id="loan_Amt" style="width: 300px" readonly value="<%=loan_Amt%> 원" />
                    </td>
                ...
                <tr>
                    <th>주문번호</th>
                    <td>
                        <input type="text" name="loan_Moid" style="width: 300px" readonly value="<%=loan_Moid%>" />
        ...
        <%--        <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <input type="text" name="loan_buyerName" style="width: 200px" readonly value="<%=loan_buyerName%>" />
