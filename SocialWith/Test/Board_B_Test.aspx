<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Board_B_Test.aspx.cs" Inherits="Test_Board_Board_B_Test" %>
                ...
                <asp:ListView ID="lvBoardList" runat="server" ItemPlaceholderID="phItemList">
                    ...
                    <ItemTemplate>
                        <tr class="board-tr-height">
                            ...
                            <td>
                                <asp:HyperLink runat="server" Text='<%#Eval("Board_Title").ToString()%>' NavigateUrl='<%# string.Format("Board_B_View_Test.aspx?Svid={0}&ucode=04", Eval("SVID_BOARD").ToString()) %>'></asp:HyperLink>
                            </td>
                            <td style="text-align: center">
