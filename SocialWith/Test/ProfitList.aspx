...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#txtdateVal").attr('value', $.datepicker.formatDate('yymm', new Date()));

        /* MonthPicker 선택 이벤트 */
        //$('#txtdate').monthpicker().bind('monthpicker-click-month', function (e, month) {
            ...
            var callback = function (response) {
                ...
                if (!isEmpty(response)) {
                    ...
                    $.each(response, function (index, value) {
                        ...
                        asynTable += "<td class='txt-center'>" + value.Company_Code + "<br />(" + fnOracleDateFormatConverter(value.PayCashDate) + ")</td>"; // 구매사(입금날짜)
        ...
        <div class="sub-contents-div">
            ...
            <div class="search-div">
                <table class="tbl_main">
                    ...
                    <tr>
                        <th>정산월</th>
                        <td>
                            <input type="text" id="txtdate" class="calendar" maxlength="10" placeholder="2018-01"> 
                            <input type="hidden"  id="txtdateVal" value="" />
                            <%--<input type="button" id="txtdate-button" style="background: url('../../Images/Goods/calendar.jpg'); overflow: hidden; width:100%;" />--%>
            ...
            <div class="profitList-div" style="width: 100%;">
                ...
                <div class="bt-align-div">
                    ...
                    <input class="mainbtn type1" type="button" value="조회 엑셀저장" />
