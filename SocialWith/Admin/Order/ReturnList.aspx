<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ReturnList.aspx.cs" Inherits="Admin_Order_ReturnList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function fnSearch(pageNum) {
            ...
            var returnStat = $('#<%=ddlReturnStatus.ClientID %>').val();
            ...
            var sUser = '<%= Svid_User%>';
            var param = { RtnChgGubun: '14', OrdStatus: returnStat, TodateB: startDate, TodateE: endDate, BuyComp: buyComp, SaleComp: saleComp, Flag: 'RtnChgList_Admin', PageNo: pageNum, PageSize: pageSize };
    ...
    <div class="sub-contents-div">
        ...
        <div class="div-main-tab" style="width: 100%; ">
                <ul>
                    ...
                    <li class='tabOff' style="width: 185px;" onclick="fnTabClickRedirect('ExchangeList');">
        ...
        <div class="search-div">
            <table id="Search-table" class="tbl_main">
                ...
                <tr>
                    ...
                    <th>진행상태</th>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlReturnStatus" CssClass="medium-size">
            ...
            <table id="list-table" class="tbl_main">
                <thead>
                    <tr>
                        ...
                        <th style="width: 60px;" rowspan="2">반품유형</th>
                        <th style="width: 40px;" rowspan="2">반품수량</th>
                        <th style="width: 70px;" rowspan="2">반품금액</th>
