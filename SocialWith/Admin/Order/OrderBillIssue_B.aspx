<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OrderBillIssue_B.aspx.cs" Inherits="Admin_Order_OrderBillIssue_B" %>
            ...
            var callback = function (response) {
                ...
                if (!isEmpty(response)) {
                    ...
                    $.each(response, function (key, value) {
                        ...
                        asynTable += "<td rowspan='2' class='txt-center'>이전 <i class='fas fa-minus-circle'></i></td>";
                        ...
                        //과세
                        if (isEmpty(billNo) || isEmpty(MD5)) {
                            tdMD5Bill = "<input type='button' class='btnDelete' value='바로가기'>";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="sub-contents-div">
        ...
        <div class="div-main-tab" style="width: 100%;">
             <ul>
                <li class="tabOff" style="width: 185px;" onclick="fnTabClickRedirect('OrderBillMain_B');">
                    <a onclick="fnTabClickRedirect('OrderBillIssue_B');">최종현황</a>
                </li>
                <li class="tabOn" style="width: 185px;" onclick="fnTabClickRedirect('OrderBillIssue_B');">
                    <a onclick="fnTabClickRedirect('OrderBillIssue_A');">이슈현황</a>
                </li>
            </ul>
        </div>
