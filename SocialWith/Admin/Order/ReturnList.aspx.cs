...
public partial class Admin_Order_ReturnList : AdminPageBase
{
    ...
    protected void btnExcelExport_Click(object sender, EventArgs e)
    {
        ...
        var fileName = Server.UrlEncode(AdminId + "_반품내역현황");
        //string[] headerName = { "진행상태", "반품일자", "반품번호", "주문일자", "주문번호", "구매사", "주문자", "요청자", "예산부서", "예산계정", "판매사", "주문상품정보", "모델명", "내용량", "상품가격", "주문금액", "수량", "배송완료일", "결제수단", "반품유형", "반품수량", "반품금액", "배송비구분" };
        string[] headerName = { "진행상태", "반품일자", "반품번호", "주문일자", "주문번호", "구매사", "주문자", "판매사", "주문상품정보", "모델명", "내용량", "상품가격", "주문금액", "수량", "배송완료일", "결제수단", "반품유형", "반품수량", "반품금액", "배송비구분" };
    ...
    public void ExportExcel(string fileName, string[] headerNames, DataTable table)
    {
        using (ExcelPackage pck = new ExcelPackage())
        {
            ...
            ExcelWorksheet ws = pck.Workbook.Worksheets.Add("반품내역현황");
            ...
            if (table.Rows.Count > 0)
            {
                ...
                ws.Cells[6, 12, table.Rows.Count + 5, 13].Style.Numberformat.Format = "#,###원";
