<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Board_A.aspx.cs" Inherits="Admin_Board_Board_A" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="sub-contents-div">
        ...
        <div class="div-main-tab" style="width: 100%; ">
                <ul>
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('Board_A');">
                        <a onclick="fnTabClickRedirect('Board_A');">판매사</a>
                     </li>
                    <li class='tabOff' style="width: 185px;" onclick="fnTabClickRedirect('Board_B');">
            ...
            <asp:ListView ID="lvBoardList" runat="server" ItemPlaceholderID="phItemList">
                ...
                <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:HyperLink runat="server"  Text='<%#Eval("Board_Title").ToString()%>' NavigateUrl='<%# string.Format("Board_A_View.aspx?Svid={0}&ucode=04", Eval("SVID_BOARD").ToString()) %>' ></asp:HyperLink> 
                            </td>
                            <td style="text-align:center">
