<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Board_A_View.aspx.cs" Inherits="Admin_Board_Board_A_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="sub-contents-div">
        ...
        <div class="board-view-div" style="padding-top: 30px">
            <table class="tbl_main">
                ...
                <tr style="border: 1px solid #a2a2a2">
                    ...
                    <td class="padding-left-ten" style="border-bottom: 1px solid #a2a2a2;" colspan="3">
        ...
        <div class="bottomBtn" style="text-align: right;">
            ...
            <input type="button" class="mainbtn type1" style="width: 95px; height: 30px;" value="목록" onclick="location.href = 'Board_A.aspx?ucode=' + ucode; return false;" />
