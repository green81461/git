...
public partial class Admin_Member_MemberPersonalInfo_B : AdminPageBase
{
    ...
    protected void GetUserInfoBind()
    {
        if (!string.IsNullOrWhiteSpace(uId))
        {
            ...
            if (userInfo != null)
            {
                ...
                txtUptae.Text = userInfo.UserInfo.Uptae; //업태
                txtUpjong.Text = userInfo.UserInfo.Upjong; //업종
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        int result = userService.UpdateUserInfo_Admin(paramList); // 회원정보 수정(이름,직책,휴대폰번호,이메일, 업태, 업종)
        ...
        //Response.Redirect("MemberMain_B.aspx");
    }
    #endregion
