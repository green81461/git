<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="MemberMain_A.aspx.cs" Inherits="Admin_Member_MemberMain_A" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
            ...
            var callback = function (response) {
                ...
                if (!isEmpty(response)) {
                    $.each(response, function (key, value) {
                        ...
                        asyncTable += "<td class='txt-center'><a onclick='fnLoginSaleComp(\"" + value.Svid_User + "\", \"" + value.Id + "\")'><img src='../../Images/login_seller.png' alt='로그인'  /></a></td>";
        ...
        function fnLoginSaleComp(sviduser, id) {
            ...
            frmPop.openNewWindowGubun.value = 'SU';
            frmPop.method = "post";
            frmPop.submit();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="all">
        <div class="sub-contents-div">
            ...
            <div class="fileDiv" style="margin-bottom: 10px; height: 10px; clear: both;">
                ...
                <%-- <table class="tbl_file">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnExcelUpload" CssClass="mainbtn type1" Text="엑셀업로드" runat="server" OnClick="btnExcelUpload_Click" />
                             <asp:Button ID="btnExcelFormDownload" Text="엑셀업로드폼 다운로드" runat="server" OnClick="btnExcelFormDownload_Click" CssClass="mainbtn type1" />
                        </td>    
                    </tr>
                </table>--%>
            </div>
            ...
            <div class="left-dv">
                <%--<input type="text" readonly="readonly" value="100" class="num"/>개/ 총<input type="text" readonly="readonly" value="500" class="num"/>개--%>
                ...
                <table id="tblMemberList" class="tbl_main">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" style="width: 27px">번호</th>
                            <th class="txt-center" style="width: 66px">회사연동<br />
                                코드</th>
                            <th class="auto-style2">아이디</th>
                            <th class="td-bgColor" style="width: 124px">회사명</th>
                            <th style="width: 78px">사업장코드<br />
                                (사업장명)</th>
                            <th rowspan="2" style="width: 63px">부서코드<br />
                                (부서명)</th>
                            <th rowspan="2" style="width: 55px">승인<br />
                                여부</th>
                            <th rowspan="2" style="width: 60px">대표자명</th>
                            <th rowspan="2" class="td-bgColor" style="width: 80px">플랫폼<br />
                                유형</th>
                            <th style="width: 105px">전화번호</th>
                            <th style="width: 138px">팩스번호</th>
                            <th style="width: 67px">SMS<br />
                                동의</th>
                            <th style="width: 55px">배너유무</th>
                            <th style="width: 55px">사용유무</th>
                            <th style="width: 95px">변경자</th>
                            <th style="width: 68px">수정날짜</th>
                        </tr>
