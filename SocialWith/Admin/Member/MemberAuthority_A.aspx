<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="MemberAuthority_A.aspx.cs" Inherits="Admin_Member_MemberAuthority_A" %>
...
<!--회원정보-권한관리-->
            <div class="sub-title-div"><img src="../Images/Member/memberInfo_b.jpg" alt="회원정보(판매사)"/></div>
    
<!--탭메뉴-->          
            <div class="sub-tab-div">
	    		<ul>
		    		<li>
			    		<a href="MemberCorpInfo_A.aspx?uId=<%=uId %>"><img src="../Images/Member/corpInfo-off.jpg" alt="회사기본정보"/></a>
				    	<a href="MemberPersonalInfo_A.aspx?uId=<%=uId %>"><img src="../Images/Member/personalInfo-off.jpg" alt="개인정보"/></a>
                        <a href="MemberAuthority_A.aspx?uId=<%=uId %>"><img src="../Images/Member/authority-on.jpg" alt="권한관리"/></a>
				        <a href="MemberLogInfo_A.aspx?uId=<%=uId %>"><img src="../Images/Member/log-off.jpg" alt="활동정보"/></a>
