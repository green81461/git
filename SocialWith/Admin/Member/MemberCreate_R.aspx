<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="MemberCreate_R.aspx.cs" Inherits="Admin_Member_MemberCreate_R" %>
<%--~/Master/Login.master--%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fnValidation() {
            ...
            if ($('#hdBusinessNumCheckFlag').val() == '0') {
                alert('판매사 가입확인을 해주세요.');
                return false;
            }
        ...
        function fnBusinessNumChk() {
            ...
            if (txtBusinessNum1.val() == '' || txtBusinessNum2.val() == '' || txtBusinessNum3 == '') {
                alert('사업자번호를 입력해주세요.');
                txtBusinessNum1.focus();
                return false;
            }
            ...
            var param = {
                CompNo: compNo,
                Flag: 'GetTypeACompCountByCompNo'
            };
            ...
            var callback = function (response) {
                if (!isEmpty(response) && parseInt(response) > 0) {
                    result = true;
                    $('#hdBusinessNumCheckFlag').val(1);
                    alert('판매사 가입이 확인되었습니다.');
                } else {
                    result = false;
                    $('#hdBusinessNumCheckFlag').val(0);
                    alert('판매사 가입이 되어있지 않습니다.');
                }
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="sub-contents-div">
        ...
        <div class="sub-title-div">
            <p style="font-size: 30px; margin-bottom: 20px; font-weight: bold; text-align: center;">RMP 회원가입</p>
            <%--<p style="font-size:15px;  margin:10px 0 20px 0; text-align:center;">회원님을 위한 다양한 혜택이 기다리고 있습니다. </p>--%>
            <p style="border: 1px solid #b1b1b1; padding-top: 20px; padding-bottom: 10px; text-align: center;">
                <img src="/images/MemberCreate_nam.jpg" /></p>
            <asp:HiddenField runat="server" ID="hfDomain" />

            <h3 style="font-size: 14px;margin: auto;margin-top: 20px; width: 1180px; margin-bottom: 10px;"><span>
                <img style="margin-right: 5px;" src="/images/base_impor.jpg" /></span>기본정보입력 <span style="font-size: 11px; font-weight: 400; padding-left: 15px; color: #ee2248">*표시는 필수입력 항목이오니 반드시 입력해주세요.</span></h3>

            <div class="table-div1" style="margin: auto; margin-bottom: 40px;">
                ...
                <table class="member-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" class="mainbtn type1" style="width: 105px; vertical-align: middle; height: 25px !important; font-size: 12px;line-height: inherit;" value="아이디 중복확인" onclick="fnCheckId(); return false;" />
            ...
            <h3 style="font-size: 14px;margin: auto;margin-top: 20px; width: 1180px;margin-bottom: 10px;">
                <img style="margin-right: 5px;" src="/images/company_nam.jpg" />회사정보입력 <span style="font-size: 11px; font-weight: 400; padding-left: 15px; color: #ee2248;">*표시는 필수입력 항목이오니 반드시 입력해주세요.</span></h3>
            <div class="table-div1" style="margin:auto; margin-bottom: 40px;">
                <table class="member-table">
                    <tr>
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="txtBusinessNum3" runat="server" TextMode="Number" max="99999" oninput="return maxLengthCheck(this)" MaxLength="5" Width="70px" onkeypress="return onlyNumbers(event);" CssClass="taxId3"></asp:TextBox>
                           <input type="button" class="mainbtn type1" style="width: 105px; vertical-align: middle; height: 25px !important;font-size: 12px;line-height: inherit;" value="판매사 가입확인" onclick="fnBusinessNumChk();"> <span>＊사업자번호나 고유번호를 입력해주세요.</span>
                            <input type="hidden" id="hdBusinessNumCheckFlag" value="0"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="button" class="mainbtn type1" style="width: 95px; vertical-align: middle; height: 25px !important;font-size: 12px;line-height: inherit;" value="우편번호 검색" onclick="openPostcode();" />
                        </td>
                    </tr>
            ...
            <h3 style="font-size: 14px;margin: auto;margin-top: 20px; width: 1180px;margin-bottom: 10px;"><span>
                <img style="vertical-align: bottom;" src="/images/market_nam.jpg" /></span>마켓팅 활용 입력 <span style="font-size: 11px; padding-left: 15px; font-weight: 400; color: #ee2248;">(선택사항)</span></h3>
            <div class="table-div1" style="margin:auto; margin-bottom: 40px;">
            ...
            <p style="font-size: 14px;margin: auto; margin-top: 20px; width: 1180px; margin-bottom: 10px;"><span style="margin-right: 5px;">
                <img src="/images/text_star_red.png" /></span><span style="margin-right: 10px; color: #ee2248; font-size: 18px; margin-top: 50px;">문서등록</span> <span>초기 문서를 등록하시는 고객님께서는 보다 신속한 거래가 가능합니다.(청부파일 확장자는DOC, HWP, PDF, JPG로 제한되어있습니다.)</span></p>

            <div class="id-table-div" style="border: none; height: auto; margin:auto;">
            ...
            <div class="bottomBtn" style="width: 1432px; margin-top: 15px;">
                ...
                <%--<asp:Button ID="btnCancel" runat="server" Text="취소" CssClass="mainbtn type1" Width="95" Height="30" />--%>
                <input type="reset" class="mainbtn type1" style="width:95px; height:30px;" value="취소" onclick="return fnCancle();">
            </div>
        </div>
    </div>
</asp:Content>
