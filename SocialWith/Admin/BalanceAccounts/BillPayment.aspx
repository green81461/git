<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="BillPayment.aspx.cs" Inherits="Admin_BalanceAccounts_BillPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="all">
            ...
            <div class="div-main-tab" style="width: 100%; ">
                <ul>
                   ...
                   <%-- <li class='tabOff' style="width: 185px;" onclick="fnTabClickRedirect('ReturnList');">
                    ...
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('BillPayment');">
            ...
            <div class="search-div">
                <table id="tblSearch" class="tbl_main">
                    ...
                    <tr>
                        ...
                        <th>판매사</th>
                        <td>
                            <asp:TextBox ID="txtSaleCompName" CssClass="medium-size" runat="server" OnKeypress="return fnEnter();"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>결제수단</th>
                        ...
                        <th>구매사</th>
                        <td>
                            <asp:TextBox ID="txtBuyerCompName" CssClass="medium-size" runat="server" OnKeypress="return fnEnter();"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="productDiv" class="popupdiv divpopup-layer-package">
            <div class="popupdivWrapper" style="width:1170px; height:750px;">
                <div class="popupdivContents" style="border: none;">
                    <div class="close-div">
                        <a onclick="fnClosePopup('productDiv'); return false;" style="cursor: pointer">
                            <img src="../../Images/Wish/icon-delete.jpg" alt="닫기" style="float: right;" />
                        </a>
                    </div>
                    <div class="popup-title" style="margin-top: 20px;">
                            <h3 class="pop-title">주문상품 조회</h3>
                        </div>
                    ...
                    <div class="tblOrder-div" style="height: 270px; width: 100%; overflow-y: auto; overflow-x: hidden;">
                        <table id="tblOrder" class="tbl_main tbl_popup">
                            <thead>
                                <tr>
                    ...
                    <div class="btn_center">
                        <input type="submit" value="확인" onclick="fnClosePopup('productDiv'); return false;" class="mainbtn type1" style="width:75px;">
                    </div>
                </div>
            </div>
        </div>
