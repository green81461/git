<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="BorderTypeMain.aspx.cs" Inherits="Admin_Company_BorderTypeMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        #tblBorderList tr.selected {
            background-color: gainsboro
        }
    </style>
    <script type="text/javascript">

        $(document).on('click', '#tblBorderList td:not(:nth-child(5))', function () {
        ...
        function fnManagement(el, flag) {
            ...
            var param = { Code: hdCode, DelFlag: flag, Flag: 'BorderTypeMgt' };
            ...
            //JajaxDuplicationCheck('Post', '../../Handler/Admin/CompanyHandler.ashx', param, 'text', callback, beforeSend, complete, true, sUser);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="all">
        ...
        <div class="sub-contents-div">
            ...
            <div class="div-main-tab" style="width: 100%;">
                <ul>
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('BorderTypeMain');">
                        <a onclick="fnTabClickRedirect('BorderTypeMain');">구매사 주문 유형 조회</a>
                    </li>
                    <li class='tabOff' style="width: 185px;" onclick="fnTabClickRedirect('BorderTypeRegister');">
                ...
                <div class="bottom-search-div" style="margin-bottom: 1px">
                    <table class="notice-search-table" style="width: 100%; margin-top: 30px; margin-bottom: 30px; border: 1px solid #a2a2a2;">
                        <tr>
                            ...
                            <td style="width: 90px">
                                <asp:DropDownList ID="ddlSearchDelFlag" runat="server" Width="150px">
            ...
            <div class="brand-search">
                ...
                <asp:ListView ID="lvList" runat="server" ItemPlaceholderID="phItemList" OnItemDataBound="lvList_ItemDataBound">
                    <LayoutTemplate>
                        <table id="tblBorderList" class="tbl_main" style="margin-top: 0; text-align: center;">
                            <colgroup>
                            ...
                            <thead>
                                <tr class="board-tr-height">
                                    ...
                                    <th class="txt-center">구매사 주문
                                        <br />
                                        유형코드</th>
                                    <th class="txt-center">구매사 주문 유형명</th>
                    ...
                    <ItemTemplate>
                        <tr class="board-tr-height" onmouseover="fnSetRowColor(this,'over');" onmouseout="fnSetRowColor(this,'out');">
                            ...
                            <td style="width: 8%" class="txt-center" id="tdCode">
                                <%# Eval("BorderCode").ToString()%>
                            </td>
                            <td class="txt-center" id="tdName">
                                <%# Eval("BorderName").ToString() %>
                            </td>
                            <td class="txt-center">
                                <%# Eval("DelFlag_Name").ToString() %>
                            </td>
                            <td class="txt-center">
                                <input type="hidden" name="hdCode" value="<%# Eval("BorderCode").ToString()%>" />
                    ...
                    <EmptyDataTemplate>
                        <table class="board-table" style="margin-top: 0;">
                            ...
                            <thead>
                                <tr class="board-tr-height">
                                    <th class="txt-center">번호</th>
                                    <th class="txt-center">구매사 주문 유형코드</th>
                                    <th class="txt-center">구매사 주문 유형명</th>
                                    <th class="txt-center">사용유무</th>
                                    <th class="txt-center">설정</th>
                                    <th class="txt-center">등록자</th>
    ...
    <div id="bordertypeDiv" class="popupdiv divpopup-layer-package">
                ...
                <div class="divpopup-layer-container">
                    ...
                    <div class="divpopup-layer-conts">
                        <table style="width: 100%" class="tbl_main">
                            <tr class="board-tr-height">
                                <th class="txt-center" style="width: 100px">주문 유형코드
                                </th>
                                <td class="txt-center" style="width: 100px">
                                    <asp:Label runat="server" ID="lblPopupCode" Width="99%" Height="26px"></asp:Label>
                                </td>
                                <th class="txt-center" style="width: 100px">주문 유형명  
                                </th>
                            ...
                            <tr class="board-tr-height">
                                ...
                                <td colspan="3" style="padding-left: 5px;">
                                    <asp:TextBox runat="server" ID="txtPopupRemark" Width="99%" Height="26px" onkeypress="preventEnter(event)" Style="border: 1px solid #a2a2a2"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <br />
