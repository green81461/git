...
public partial class Admin_Login : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!(ip == "127.0.0.1" || ip == "::1") && CommonHelper.SiteName() != "socialwith" && siteType != "TestServer")
        {
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        // 사용자 정보가 있는 경우
        if ((userInfo != null) && (userInfo.Id != null) && userInfo.Gubun.Substring(0, 2) == "AU")
        {
            ...
            if (userInfo.ConfirmFlag == "Y")
            {
                var insertParamList = new Dictionary<string, object>
                {
                    ...
                    {"nvar_P_GUBUN", "4" }, // 1.구매사 2.판매사 3.RMP 4.관리자, 5 그룹G
