...
public partial class Admin_Goods_RecommServiceListSearch : AdminPageBase
{
    ...
    protected void click_Delete(object sender, EventArgs e)
    {
        ...
        Response.Redirect(string.Format("RecommServiceListSearch.aspx?ucode="+ Ucode)); //메인으로 가기.
