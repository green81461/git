<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="RecommManagement.aspx.cs" Inherits="Admin_Goods_RecommManagement" %>
    ...
    <script type="text/javascript">
                ...
                if (!isEmpty(response)) {
                    ...
                    $.each(response, function (key, value) { //테이블 추가
                        ...
                        if (curCodesArray.contains(value.GoodsCode) == false) {
                            ...
                            newRowContent += "<input type='number' id='txtQty'   value='" + value.GoodsUnitMoq + "'  onblur='fnQtyTextBlur(this); return false;'/>"
        ...
        function fnSaveGoodsRecomm() {
            ...
            var callback = function (response) {
                if (response == 'Success') {
                    alert('저장되었습니다.');
                    location.href = 'RecommListSearch.aspx?ucode=' + ucode;
                }
                else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="sub-contents-div">
        ...
        <div class="div-main-tab" style="width: 100%; ">
                <ul>
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('RecommManagement');">
                        <a onclick="fnTabClickRedirect('RecommManagement');">추천상품 생성</a>
                     </li>
                    <li class='tabOff' style="width: 185px;" onclick="fnTabClickRedirect('RecommListSearch');">
            ...
            <table class="tbl_search">
                <tr>
                    ...
                    <td style="width:80%">
                        ...
                        <input type="text" placeholder="상품명/상품코드를 입력하세요" style="width:82%; height:26px" id="txtGoodsSearch" onkeypress="return fnGoodsSearchEnter();"/>
                    </td>
                    <td class="txt-center">
        ...
        <div style="padding-top:10px">
            <table class="tbl_main">
                <tr>
                    <th style="width: 60px">
                        <input type="checkbox" onclick="fnSelectAll(this, 'Goods');">
                    </th>
                    ...
                    <th style="width: 70px">판매사<br/>수익률
                    </th>
                    <th style="width: 90px">구매가
                    </th>
                    <th style="width: 110px">변경가
                    </th>
                    <th style="width: 70px">소셜위드<br/>수익률
                    </th>
                ...
                <tbody id="tblGoods_Tbody">
                    <tr id="GoodsEmptyRow">
                        <td class="txt-center" colspan="13">
                            상품을 검색해 주세요.
                        </td>
                    </tr>
                </tbody>
    ...
    <div id="goodsListPopupdiv" class="popupdiv divpopup-layer-package">
        <div class="popupdivWrapper" style="width:650px; height:750px; margin: 30px auto;">
            <div class="popupdivContents">
                ...
                <div class="popup-title">
                    <h3 class="pop-title">상품 조회</h3>
                </div>
                  

                    <div class="search-div" style="margin-bottom: 20px;">
                        <select id="selectPopupGoodsTarget" style="height:26px; width:150px; vertical-align:middle">
                    ...
                    <div class="divpopup-layer-conts">
                        <table id="tblPopupGoods" class="tbl_main tbl_popup" style="margin-top: 0; width: 100%">
                            <thead>
                                <tr>
