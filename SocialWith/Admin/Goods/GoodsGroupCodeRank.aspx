<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="GoodsGroupCodeRank.aspx.cs" Inherits="Admin_Goods_GoodsGroupCodeRank" EnableEventValidation="false" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#tblGroupList").on("click", "tr", function (e) {
                ...
                var num1 = td.parent().find('.tdRank').text(); //두번째 
                
                $('#hdBaseRank').val(num1);
                if (tr.hasClass('groupTr')) {
                    tr.addClass('on');
                    $('#txtCodeModify').text(code1); //넣어주기
                    $('#txtRankModify').val(num1);
                }
        ...
        function fnSearchClick() { //검색 버튼 클릭시 
            ...
            var callback = function (response) {
                ...
                if (!isEmpty(response)) {
                    ...
                    $.each(response, function (key, value) {
                        ...
                        groupList += "<td class='tdCode'>" + value.GoodsGroupCode + "</td>" //그룹코드
                        groupList += "<td class='tdRank'>" + value.GoodsGroupRank + "</td>" //랭크
                        groupList += "</tr>"
                    ...
                    groupList += "<tr >"
                    groupList += "<td colspan='2' >조회된 데이터가 없습니다.</td>"
                    groupList += "</tr>"
                    $("#tblGroupList").empty().append(groupList);
            ...
            var param = {
                ...
                Method: 'GetGroupCodeListByCategory'
            };
        ...
        function fnUpdateRank() {
            if ($('#txtRankModify').val() != 0) {
                ...
                var param = {
                    GroupCode: $('#txtCodeModify').text(),
                    BaseRank: $('#hdBaseRank').val(),
                    GroupRank: $('#txtRankModify').val(),
                    Method: 'UpdateGoodsGroupCodeRank'
        ...
        <div class="sub-contents-div" style="min-height: 1500px">
            ...
            <div class="div-main-tab" style="width: 100%;">
                <ul>
                    ...
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('GoodsGroupCodeRank');">
            ...
            <div class="bottom-search-div" style="margin-bottom: 20px">
                ...
                <div class="category-rank">
                    <div class="category-rank-columns">
                        <p class="category-rank-title">그룹코드 Rank 구조</p>
                        <div class="rank-div">
                            ...
                            <span style="color: #69686d; float: left; margin-top: 10px; margin-bottom: 5px;"><b style="color: #ec2029; font-weight: bold;">그룹을 클릭해주세요</b></span>
                        </div>
                    </div>
                    <div class="category-rank-columns">
                        <p class="category-rank-title">그룹코드 Rank 변경</p>
                        <div class="rank-div">
                            <table class="tbl_main">
                                <colgroup>
                                    <col style="width: 50%" />
                                ...
                                <tbody id="tblGroupRankModify">
                                    <tr class="height">
                                        <th>그룹코드</th>
                                        <td id="txtCodeModify"></td>
                                    </tr>
                                    <tr class="height">
                                        <th>Rank 순위</th>
                                        <td>
                                            <input type="hidden" id="hdBaseRank">
                                            <input type="number" id="txtRankModify" style="ime-mode: disabled;" onkeypress="return fnGoodsUpdateEnter();" onkeyup='removeChar(event)' onkeydown="return numberKey(event)"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="rank-btn">
