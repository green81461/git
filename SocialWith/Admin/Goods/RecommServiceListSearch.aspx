<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="RecommServiceListSearch.aspx.cs" Inherits="Admin_Goods_RecommServiceListSearch" %>
                ...
                if (!isEmpty(response)) {
                    ...
                    $.each(response, function (key, value) {
                        ...
                        if (key == 0) {
                            ...
                            $('#aPopupDown').text(value.AttachPName);
    ...
    <div class="all">
        <div class="sub-contents-div">
            ...
            <div class="div-main-tab" style="width: 100%; ">
                <ul>
                    <li class='tabOff' style="width: 185px;" onclick="fnTabClickRedirect('RecommServiceManagement');">
                        <a onclick="fnTabClickRedirect('RecommServiceManagement');">추천서비스 생성</a>
                     </li>
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('RecommServiceListSearch');">
            ...
            <div class="popupdivContents">
                ...
                <div class="divpopup-layer-conts">
                    <table class="tbl_main tbl_pop">
                        ...
                        <tr>
                            <th>첨부파일</th>
                            <td><input type="hidden" id="hdFileName"/><input type="hidden" id="hdFilePath"/><a onclick="fnFileDownload(this); return false;" id="aPopupDown" style="cursor: pointer;"></a></td>
                        </tr>
                    </table>
                     <div class="divpopup-layer-conts" style="margin-top:5px">
                        <table class="tbl_main tbl_pop" >
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width:330px">서비스정보</th>
                                    <th class="text-center" style="width:100px">모델명</th>
                                    <th class="text-center" style="width:80px">단위</th>
                                    <th class="text-center" style="width:90px">서비스가격<br />
