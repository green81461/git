<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="GoodsServiceRegister.aspx.cs" Inherits="Admin_Goods_GoodsRegister" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
                    ...
                    $.each(response, function (key, value) {
                        ...
                        switch (key) {
                            ...
                            case "comm_11":  //배송구분
                                ...
                                //for (var i = 1; i < value.length; i++) {
                                createHtml = '<option value="' + value[6].Map_Type + '">' + value[6].Map_Name + '</option>'; //서비스용역만
        ...
        function fnAutoComma(event) {
            ...
            if (id == 'ContentPlaceHolder1_txtGoodsSalePrice') {
                ...
                goodsCustPrice2 = roundXL(goodsCustPrice2, -1);
        ...
        function fnCreateGroupCode() {
            ...
            var sUser = '<%=Svid_User %>';
            var param = {
                Method: 'CreateGoodsServiceGroupCode'
            };
        ...
        <div class="sub-contents-div" style="min-height: 1500px">
            ...
            <div class="div-main-tab" style="width: 100%;">
                <ul>
                    ...
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('GoodsServiceRegister');">
          ...
          <%--  <div class="fileDiv">
                <table class="tbl_file">
                    <tr>
                    <th rowspan="3" style="width: 170px;">견적서 업로드</th>
                    <td>
                        <input type="file" id="fileEstmt" />
                    </td>
                </tr>
                </table>
            ...
            <table class="tbl_main" id="tblGoodsModify">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="button" value="서비스용역코드생성" class="btnDelete" onclick="return createCode(this)" id="aGoodsCode">
