<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OSGoodsPriceManagement.aspx.cs" Inherits="Admin_Goods_OSGoodsPriceManagement" %>
            ...
            var callback = function (response) {
                ...
                if (!isEmpty(response)) {
                    ...
                    $.each(response, function (key, value) { //테이블 추가
                        ...
                        newRowContent += "<td class='txt-center' style='background-color:#E8FFFF'>" + numberWithCommas(value.GoodsCustPrice) + "원<br/>";  
                        ...
                        newRowContent += "<td class='txt-center' style='" + colColor + "'><input type='text' id='txtPrice' style='width:80%; ' value='" + price + "' " + disableStyle + " onkeyup='return fnAutoComma(this);' onkeypress='return onlyNumbers(event);'>원<div id='divVatPrice' style='float:left; height:20px; padding-left:7px'>";  //판매사 판매가격입력
         ...
         <!--탭영역-->
            <div class="div-main-tab" style="width: 100%; ">
                <ul>
                    ...
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect('OSGoodsPriceManagement');">
                 ...
                 <table id="tblSaleComp" class="tbl_main">
                     <thead>
                           ...
                           <tr class="board-tr-height">
                                    ...
                                    <th class="txt-center" style="width:120px">판매사코드</th>
                                    <th class="txt-center" style="width:auto">판매사명</th>
          ...
          <div id="divTableList2" style="position: relative;">
                <table id="tblList2" class="tbl_main">
                    <thead>
                        <tr>
                            <th style="width:60px">
                                선택<br/><input type="checkbox" id="selectAll" onclick="fnSelectAll(this);">
                            </th>
