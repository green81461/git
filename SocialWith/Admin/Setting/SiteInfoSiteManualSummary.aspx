<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SiteInfoSiteManualSummary.aspx.cs" Inherits="Admin_Setting_SiteInfoSiteManualSummary" %>
        ...
        <div class="sub-contents-div">
            ...
            <div class="div-main-tab" style="width: 100%;">
                <ul>
                    ...
                    <li class='tabOn' style="width: 185px;" onclick="fnTabClickRedirect(SiteInfoSiteManualSummary');">
                    ...
                    <li class='tabOff' style="width: 185px;" onclick="fnTabClickRedirect('SiteInfoSiteManualCalculation');">
