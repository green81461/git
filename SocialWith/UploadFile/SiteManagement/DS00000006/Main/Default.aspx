        ...
        <form id="form1" runat="server">
            ...
            <header>
                <div class="topbanner-wrap" id="divTopmenu" runat="server" style="display: none">
                    ...
                    <a href="#none" id="btnTopMenuCls">
                        <img src="/Images/icon_close_24x24.png" alt="닫기" /></a>
                </div>
                <%--                <div>
            ...
            <div class="contents-main">
               ...
               <div class="main-csbanner-wrap"  style="margin-top:85px">
                ...
                <li>
                    ...
                    <a href="javascript: ;" class="btmico02 close" style="display: none;">
                        <p style="font-size: 18px; padding-bottom: 2px;">
                            <img src="./images/close-bottom.png" />
                        </p>
                        <p>닫기</p>
                    </a>
