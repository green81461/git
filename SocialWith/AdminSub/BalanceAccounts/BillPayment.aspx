<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSub/Master/AdminSubMaster.master" AutoEventWireup="true" CodeFile="BillPayment.aspx.cs" Inherits="AdminSub_BalanceAccounts_BillPayment" %>
        ...
        <div class="sub-contents-div">
            ...
            <div class="div-main-tab" style="width: 100%; ">
                <ul>
                    ...
                    <li id="lipay"  class='tabOn' style="width: 185px;">
                        <a>대금정산</a>
                    </li>
                </ul>
            </div>
