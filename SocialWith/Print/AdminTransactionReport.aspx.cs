...
public partial class Print_AdminTransactionReport : System.Web.UI.Page
{
    #region << logger >>
    ...
    {
        AdminTransactionReport report = new AdminTransactionReport();
        ...
        queryParam3.Value = Request["SaleCompCode"];
        queryParam4.Value = Request["OrdStat"];
