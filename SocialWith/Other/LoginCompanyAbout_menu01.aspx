<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Login.master" AutoEventWireup="true" CodeFile="LoginCompanyAbout_menu01.aspx.cs" Inherits="Other_LoginCompanyAbout_menu01" %>
...
<div class="tab">
  <h2>회사소개</h2>
  <button class="tablinks active" onclick="location.href = 'LoginCompanyAbout_menu01.aspx'; return false;">인사말</button>
...
<div class="tabcontent on">
    <h2>인사말</h2>
    <img src="../Images/Introduce/introduce_01.jpg" alt="인사말"/>
</div>
