<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Login.master" AutoEventWireup="true" CodeFile="LoginCompanyAbout_menu02.aspx.cs" Inherits="Other_LoginCompanyAbout_menu02" %>
...
<div class="tab">
  ...
  <button class="tablinks active" onclick="location.href = 'LoginCompanyAbout_menu02.aspx'; return false;">사업소개</button>
...
<div class="tabcontent on">
    <h2>사업소개</h2>
    <img src="../Images/Introduce/business_02.JPG" alt="사업소개"/>
</div>
