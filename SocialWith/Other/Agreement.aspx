<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../Master/Default.master" CodeFile="Agreement.aspx.cs" Inherits="Other_Agreement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        $(function () {
            $('.agreementSiteName').text($('#hdMasterDistCompanyName').val());
            $('.agreementCompName').text($('#hdMasterCompanyName').val().replace('(주)', ''));
            $('.agreementDomain').text($('#hdMasterDns').val());
        })
    </script>
    <style>
        .agreement-div2 p {
    ...
    <div class="sub-contents-div" oncontextmenu="return false" ondragstart="return false">

        <div class="agreement-div2">
            <h3>이용약관</h3>
...
게시하는 행위
  ...
  다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 민사소송법상의 관할법원에 제기합니다.
            ...
            <p>② '몰'과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</p><br />
