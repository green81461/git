...
<head runat="server">
    ...
    <%--<link rel="stylesheet" type="text/css" href="../Content/Statistics/statistics.css" />--%>
    <asp:Literal runat="server" ID="mainCss" EnableViewState="false"></asp:Literal>
    <asp:Literal runat="server" ID="commonCss" EnableViewState="false"></asp:Literal>
...
<asp:Literal runat="server" ID="mainjs" EnableViewState="false"></asp:Literal>
<script type="text/javascript">
...
<%--                <div>
                    ...
                    <div class="top_stickymenu">
                        <div class="leftinfo">
                            <ul class="leftinfo-list">
                                ...
                                <li id="liStickyCart"  style="display:none" runat="server"><a class="top_stickymenu_a" href="/Cart/CartList.aspx">장바구니 <span class="top_info_num"><asp:Label runat="server" ID="lblCartCnt"></asp:Label></span></a></li>
                            </ul>
                        </div>
                        <div class="rightinfo" >
                            <ul class="rightinfo-list" id="ulRightInfo" runat="server">
                                ...
                                <li>
                                    <a style="cursor:unset !important"><asp:Label runat="server" ID="lblUser" style="cursor:unset !important"></asp:Label></a><span class="tx_bar"></span></li>
                                <li>
                                    <a style="cursor:unset !important"><asp:Label runat="server" ID="lblDeptName" style="cursor:unset !important"></asp:Label></a><span class="tx_bar"></span></li>
                                <li class="mypage" style="width:106px; display:none">
                                    <a class="top_stickymenu_mypage" href="/Order/OrderHistoryList.aspx" style="width: 86px">
                                        <span><img src="./images/mypage_small.png" /></span>마이페이지
            ...
            <div class="contents-wrap">
                ...
                <div id="quick">
                    <div class="title">
                        ...
                        <div class="close"><img src="../Images/main/close.png" /></div>
                    </div>
                    <div class="ul">
                        <span class="li"><span class="list_name">본사</span><span class="price">7,564,000</span></span>
                        <span class="li"><span class="list_name">삼척기지본부</span><span class="price">7,564,000</span></span>
                        <span class="li"><span class="list_name">통영기지본부</span><span class="price">7,564,000</span></span>
                        <span class="li"><span class="list_name">강원지역본부</span><span class="price">7,564,000</span></span>
                        <span class="li"><span class="list_name">서울지역</span><span class="price">7,564,000</span></span>
                        <span class="li"><span class="list_name">서울지역</span><span class="price">7,564,000</span></span>
                        <span class="li"><span class="list_name">서울지역</span><span class="price">7,564,000</span></span>
                    </div>
                </div>
                ...
                <div class="contents-main">
                    ...
                    <div class="main-csbanner-wrap">
                        <div class="main-banner"><img src="./images/Banner/main_banner.png" /></div>
                    ...
                    <div class="main-best-wrap" style="">
                        <div class="main-best">
                            ...
                            <div class="main-title-wrap">
                                <span><img src="./images/recommend.png " /> </span>
         ...
         <%-- <div style="text-align:center; margin:0 auto;"><img src="./images/color_d.jpg" /></div>--%>
                   ...
                   <%--<div class="line_gy"><span><img src="./images/gray_line.jpg" /></span></div>--%>
                    ...
                    <div id="defaultMiddleBanner" style="display: none">
                        <div class="main-title-wrap">
                            <span><img src="./images/jang.png"/></span>
                    ...
                    <div id="divPartnersContent" style="display: none;">
                        <div class="main-title-wrap">
                            <span><img src="./images/agreement.jpg"/></span>
            ...
            <div class="footer-div">
                ...
                <div class="footer-menu-div">
                    <ul id="ulBottomMenu">
                        ...
                        <li id="bottomMenuLiConduct" style="display:none"><a href="/Other/Conduct.aspx">공급자행동강령</a></li>
                    </ul>
                </div>
    ...
    <div class="floatbar">
        <div class="btmbar">
            <ul class="btmBtns">
                <li><a href="/Default.aspx" class="btmico01"><p><img src="./images/b_home.png" /></p><p>홈</p></a></li>
                <li>
                    <a href="javascript: ;" class="btmico02"><p><img src="./images/b_serch.png" /></p><p>검색</p></a>
                  
                    <a href="javascript: ;" class="btmico02 close" style="display: none;"><p style="font-size:18px; padding-bottom:2px;"><img src="./images/close-bottom.png" /></p><p>닫기</p></a>
                ...
                <li id="libottomCart" style="display:none" runat="server"><a href="/Cart/CartList.aspx" class="btmico03"><p><img src="./images/b_baguni.png" /></p><p>장바구니</p></a></li>
                <li><a href="/Order/OrderHistoryList.aspx" class="btmico04"><p><img src="./images/b_myshopping.png" /></p><p>나의쇼핑</p></a></li>
                <li><a href="Other/Faq.aspx" class="btmico05"><p><img src="./images/b_call.png" /></p><p>고객센터</p></a></li>
            </ul>
            <div class="recentGoods">
                <div>
                    ...
                    <div class="recentArea">
                        ...
                        <a href="javascript: ;" class="btn_moreGoods"><p style="font-size:20px; padding-top:5px;font-weight:bold;">+</p><p>더보기</p></a>
                        <a href="javascript: ;" class="btn_moreClose" style="display: none;"><p>닫기</p><p style="font-size:18px; font-weight:bold;">X</p></a>
                        <div class="moreGoods" style="display: none;">
                            <p style="float:left;padding-right:23px;"><img src="./images/b_st.png" /></p><p style="float:left;">오늘 본 상품</p><p style="padding-left:284px;"><img src="./images/b_st.png" /></p>
            ...
            <div class="btnBtmWrap2">
                <a href="javascript:footSlide('top');" class="btn_BtmTop"><p>∧</p><p>TOP</p></a>
                <a href="javascript:footSlide('bottom');" class="btn_BtmBtm"><P>DOWN</P><p>∨</p></a>
            </div>
        </div>
    </div>

    <div class="btnBtmWrap">
        <a href="javascript: ;" class="btn_BtmDown"><p style="font-size:18px; padding-bottom:5px;font-weight:bold;">▼</p><p>접기</p></a>
        <a href="javascript: ;" class="btn_BtmUp"><p style="font-size:18px; padding-bottom:5px;font-weight:bold;">△</p><p>펴기</p></a>
    </div>
