...
public partial class Master_Default : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  subCss.Text = string.Format("<link rel=\"stylesheet\" type=\"text/css\" href=\"{0}\"/>", "../Content/sub.css?dt=" + DateTime.Now.ToString("yyyyMMddhhmmss"));
        masterjs.Text = string.Format("<script type=\"text/javascript\" src=\"{0}\"></script>", "../Scripts/master.js?dt=" + DateTime.Now.ToString("yyyyMMddhhmmss"));
        GetUser();
        GetSiteDistCss();
        SiteRedirect();
    ...
    protected void GetSiteDistCss()
    {
        ...
        if (distInfo == null)
        {
            ...
            Title = "소셜공감";
            topBannerPath = Page.ResolveClientUrl("SiteManagement/Default/Main/top_banner.png");
        ...
        else
        {
            ...
            cssPath = string.IsNullOrWhiteSpace(distInfo.CssPath) ? Page.ResolveClientUrl("SiteManagement/Default/Main/SiteInfo.css") : distInfo.CssPath;
            ...
            favicon = miniLogo = string.IsNullOrWhiteSpace(distInfo.BrowseEmtcPath) ? Page.ResolveClientUrl("SiteManagement/Default/Main/mini_logo.png") : distInfo.BrowseEmtcPath;
            topBannerPath = string.IsNullOrWhiteSpace(distInfo.TopBannerPath) ? string.Empty : distInfo.TopBannerPath;
            topLogoPath = string.IsNullOrWhiteSpace(distInfo.TopLogoImagePath) ? Page.ResolveClientUrl("SiteManagement/Default/Main/main_logo.png") : distInfo.TopLogoImagePath;
            bottomLogoPath = string.IsNullOrWhiteSpace(distInfo.BottomLogoImagePath) ? Page.ResolveClientUrl("SiteManagement/Default/Main/main_bottom_logo.png") : distInfo.BottomLogoImagePath;
            copyLogoPath = string.IsNullOrWhiteSpace(distInfo.CopyRPath) ? Page.ResolveClientUrl("SiteManagement/Default/Main/copyright.png") : distInfo.CopyRPath;
        ...
        //디폴트페이지
        //string redirectUrl = "~/UploadFile/SiteManagement/" + DistCode + "/Main/Default.master";
